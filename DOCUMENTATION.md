...
| Code highlighting | **highlight.js + lowlight** | Standard themes (GitHub Dark), tree-friendly API for Tiptap |
...
gives ~35 languages highlighted with the GitHub Dark theme.
